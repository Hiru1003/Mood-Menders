...
import 'package:myapp/pages/breathawarenessstep2.dart';
...
class breathawarenessstep1_page extends StatefulWidget{
  ...
  @override
  State<breathawarenessstep1_page> createState()  => _breathawarenessstep1_pageState();
}
            ...
            child: Column(
              ...
              //para
               Padding(
                ...
                Navigator.push(  
                context,MaterialPageRoute(builder: (context) =>    (const breathawarenessstep2_page())),  
                ); 
                }
                },
                ),
