...
class breathawarenessstep6_page extends StatefulWidget{
  ...
  @override
  State<breathawarenessstep6_page> createState()  => _breathawarenessstep6_pageState();
}
//comment
            ...
            child: Column(
               ...
               Padding(
                ...
                child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                      //image
                      Image.asset('lib/images/step20.png', height: 210,)
                      ],
                    ),
                ),
              ),
              ...
              //para
               Padding(
                ...
                Padding(
                padding: const EdgeInsets.only(left: 10, right: 10),
                child: MyButton(buttontext: 'Back to home page', onTap:(){{
                Navigator.push(  
                context,MaterialPageRoute(builder: (context) =>    ( breathawarenessmed_page())),  
                ); 
                }
                },
                ),
