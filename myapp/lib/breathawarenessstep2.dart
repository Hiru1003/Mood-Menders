...
import 'package:myapp/breathawarenessstep1.dart';
import 'package:myapp/breathawarenessstep3.dart';
...
class breathawarenessstep2_page extends StatefulWidget{
  ...
  @override
  State<breathawarenessstep2_page> createState()  => _breathawarenessstep2_pageState();
}
            ...
            child: Column(
               ...
               Padding(
                ...
                child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                      //image
                      Image.asset('lib/images/step10 .png', height: 240,)
                      ],
                    ),
                ),
              ),
              ...
              //para
               Padding(
                ...
                Padding(
                padding: const EdgeInsets.only(left: 10, right: 10),
                child: MyButton(buttontext: 'Next Step', onTap:(){{
                Navigator.push(  
                context,MaterialPageRoute(builder: (context) =>    (const breathawarenessstep3_page())),  
                ); 
                }
                },
                ),
